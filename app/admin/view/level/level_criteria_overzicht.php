...
$leveltypeList = $leveltype->getLevelList();
// Set default value
$current_page = 'CBS_admin_level_lijst';
$create = 'admin.php?page=CBS_admin_level_lijst&action=create';
$urlcreate = admin_url($create);

?>
<div class="wrap">
    <h1>Level Criteria lijst <a href="<?php echo $urlcreate; ?>" class="page-title-action">Nieuwe Level Criteria</a></h1>
    ...
    <form id="posts-filter" method="get">
        ...
        <table class="wp-list-table widefat fixed striped posts">
            ...
            <tbody id="the-list">
            <?php
            if(isset($leveltypeList)){
                foreach ($leveltypeList as $ratingType) { ?>
                    ...
                    <tr id="post-1"
                        ...
                        <td class="title column-title has-row-actions column-primary page-title" data-colname="Titel">
                            ...
                            <div class="row-actions">
                                <span class="edit">
                                    <?php
                                    $edit = 'admin.php?page=CBS_admin_level_lijst&action=update&id=' .$ratingType->getIdLevelCriteria();
                                    $urlcreate = admin_url($create);
                                    ...
                                    <span class="trash">
                                            ...
                                            $delete = 'admin.php?page=CBS_admin_level_lijst&action=delete&id=' . $ratingType->getIdLevelCriteria();
