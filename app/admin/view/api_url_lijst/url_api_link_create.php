...
if (isset($_POST['submit_api_url_link']) && !empty($_POST['submit_api_url_link'])) {
    ...
    $api_url_link->setShortcode($_POST['api_link_systeem_afkorting']);
...
<div class="wrap">
    <h1><?php _e( 'Nieuwe API URL LINK', 'Coach Beoordeling Systeem' ); ?></h1>
    ...
    <form method="post">
        ...
        <table class="form-table">
            <tbody>
                ...
                <tr class="row-naam">
                    <th scope="row">
                        <label for="api_link_url"><?php _e( 'Shortcode', 'Backend IVS' ); ?></label>
                    </th>
                    <td>
                        <input type="text" name="api_link_systeem_afkorting" id="api_link_systeem_afkorting" class="regular-text" placeholder="<?php echo esc_attr( '', 'Backend IVS' ); ?>" value="" required="required" />
                    </td>
                </tr>
                <tr class="row-naam">
                    <th scope="row">
